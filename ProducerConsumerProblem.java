...
public class ProducerConsumerProblem {
    ...
    public ProducerConsumerProblem(int bufferSize, int productionLimit) {
    ...
    public static void main(String[] args) {
        ...
        ProducerConsumerProblem processor = new ProducerConsumerProblem(bufferSize, productionLimit);
